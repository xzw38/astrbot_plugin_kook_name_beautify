...
完整替换支持按类型选择保护范围，不依赖固定提示词。例如“不动文字，其他全部替换”会保护文字频道及其父分组；“不碰语音，其他全部替换”会保护语音频道及其父分组；“分组保持原样，其他全部替换”会复用现有分组。受保护类型禁止改名、移动、删除和新建，其他类型仍按要求替换。“保留”“不改”“保持原样”“除了语音其他替换”等同义表达也会使用相同的本地强制保护。
